...
* [Zama KMS](https://github.com/zama-ai/kms/) ⭐ 73 | 🐛 27 | 🌐 Rust | 📅 2026-08-24 - Zama's MPC-based key management system for threshold key generation and threshold decryption for FHE. | [WAHC'23](https://eprint.iacr.org/2023/815), [Spec](https://github.com/zama-ai/threshold-fhe/blob/main/docs/CryptographicDocumentation.pdf) ⭐ 59 | 🐛 3 | 🌐 Rust | 📅 2026-02-05
* [Stoffel](https://github.com/Stoffel-Labs/stoffel) ⭐ 69 | 🐛 3 | 🌐 Rust | 📅 2026-08-21 - A framework for robust MPC protocols which includes a custom compiler, VM runtime, SDKs targeted at developers with minimal MPC knowledge.
...
* [LibOTe](https://github.com/osu-crypto/libOTe) ⭐ 503 | 🐛 3 | 🌐 C++ | 📅 2026-08-21 - Library with various OT Extensions.
...
* [Blockchain-Crypto-MPC](https://github.com/unbound-tech/blockchain-crypto-mpc) ⭐ 480 | 🐛 2 | 🌐 C | 📅 2022-07-28 - Multiparty ECDSA signing in the cryptocurrency setting, includes an optimized GC library, OT, and more. | [CCS'18](https://eprint.iacr.org/2018/987).
