...
The list format is inspired from [awesome list](https://github.com/sindresorhus/awesome) ⭐ 499,906 | 🐛 106 | 📅 2026-08-21 and after a fruitful lunch discussion at [TPMPC](http://www.multipartycomputation.com/) back in 2017 in Bristol.
...
* [Zama KMS](https://github.com/zama-ai/kms/) ⭐ 73 | 🐛 29 | 🌐 Rust | 📅 2026-08-25 - Zama's MPC-based key management system for threshold key generation and threshold decryption for FHE. | [WAHC'23](https://eprint.iacr.org/2023/815), [Spec](https://github.com/zama-ai/threshold-fhe/blob/main/docs/CryptographicDocumentation.pdf) ⭐ 59 | 🐛 3 | 🌐 Rust | 📅 2026-02-05
* [Stoffel](https://github.com/Stoffel-Labs/stoffel) ⭐ 69 | 🐛 3 | 🌐 Rust | 📅 2026-08-25 - A framework for robust MPC protocols which includes a custom compiler, VM runtime, SDKs targeted at developers with minimal MPC knowledge.
...
* [LibOTe](https://github.com/osu-crypto/libOTe) ⭐ 503 | 🐛 4 | 🌐 C++ | 📅 2026-08-21 - Library with various OT Extensions.
...
* [Fireblocks MPC](https://github.com/fireblocks/mpc-lib/) ⭐ 269 | 🐛 4 | 🌐 C++ | 📅 2026-07-30 - Multiparty ECDSA and EdDSA | eprint [2020/492](https://eprint.iacr.org/2020/492).
